...
const SITE_CONTENT = {
  ...
  story: {
    ...
    journey: [
      "我的背景，其實和很多人一樣。不是出身於中產家庭，也沒有資源或人脈。大學剛滿18歲，用自己的錢開戶入市。當時的想法很簡單：賺錢，改變生活。",
      "我也曾經相信，只要夠努力、看夠多資訊，就能在市場中勝出。甚至為自己定過很直接的目標——幾年內做到100萬、再做到1,000萬。",
      "那些年，我沒有導師，沒有圈子，只能靠書、報章、網上零碎資料自學。很多判斷，只能自己試，自己錯，再自己修正。",
      "2012年，我開始在Facebook建立「發掘十倍股」，持續公開記錄對港股的看法；2014年開設群組，和一班同樣在市場摸索的人討論。",
      "這些內容不只是分享，更是一段長時間的實驗——\n驗證哪些方法有效，哪些完全沒用。",
    ],
    ...
    insight: "選股、新聞、消息——這些只是表面。\n真正影響結果的，是市場所處的階段、資金正在流向哪裡，以及大多數人還未察覺的變化。",

    pillars: {
      intro: "現在我的分析，主要圍繞三件事：",
      items: [
        { label: "業績變化", desc: "從財務數據中識別高增長潛力，捕捉市場尚未完全消化的訊號" },
        { label: "行業趨勢", desc: "結構性變革帶來的長期機會，而非短線消息" },
        { label: "資金與情緒", desc: "大多數人還未察覺的變化，市場所處的階段" },
      ],
    },

    aiNote: "AI 對我來說，只是一個效率器。\n它可以幫我更快篩選、更廣覆蓋，但最終的判斷，仍然來自對市場的理解。",

    valueProp: [
      "這個專欄的目的，不是提供更多資訊。\n而是幫你過濾掉大部分無用的資訊。",
      "你會在這裡看到的，不是事後分析，而是：在眾多股票之中，哪些公司正處於動能最強的位置，哪些變化正在發生，而市場仍未完全反映。然後放在模擬倉，看著它們朝著預想的方向發展。",
      "平時我會寫港股 / 美股業績分析、每週市場結構變化、行業趨勢，以及在 Discord 中即時跟進突發消息。同時配合自動篩選與量化工具，讓你更早看到機會，而不是等市場走完才理解。",
    ],
